 ...
 */
class WP_Flutterwave_Transactions_Rest_Route extends WP_REST_Controller{
	 ...
	 */
    public function get_transactions(): WP_REST_Response {
        ...
        $response = wp_remote_get($this->flw_base_url."transactions", array(
            'headers' => array(
